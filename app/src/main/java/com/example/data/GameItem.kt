...
class GameItem(
    ...
    var bonusHits: Int by mutableIntStateOf(initialBonusHits)
    var isFrozen: Boolean by mutableStateOf(initialIsFrozen)

    val isFreezeBonus: Boolean get() = category.isFreezeBonus
}
